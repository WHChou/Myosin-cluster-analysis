...
%WARNING! I use the avg10 to choose videos where I did, indeed average over
%10 frames. Take out if you're using direct movies. Also when using
%averaged data, you have to start with 2. Otherwise, start with x = 1
for x = 1:numframes
...
format long e;
% if Inv == 0
%And get rid of _avg if you're using normal data! 
